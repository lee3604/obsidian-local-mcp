...
export class StreamableHTTPServerTransport {
    ...
    validateSession(req, res) {
        if (this.sessionIdGenerator === undefined) {
            console.log("Session generator is undefined (Stateless). Valid.");
            // If the sessionIdGenerator ID is not set, the session management is disabled
            // and we don't need to validate the session ID
            return true;
        }
        if (!this._initialized) {
            console.log("Server not initialized, rejecting.");
        ...
        if (!sessionId) {
            console.log("Missing session ID header.");
    ...
    validateProtocolVersion(req, res) {
        ...
        console.log("Validating protocol version:", protocolVersion);
        console.log("Supported:", SUPPORTED_PROTOCOL_VERSIONS);
